    ...
    subroutine TRANSFER_CALC
        ...
        do t = 0.98 * transfer_epoch, 1.02 * transfer_epoch, 0.01 * transfer_epoch
            ...
            do tt = 0.98 * transfer_time, 1.02 * transfer_time, 0.01 * transfer_time
                ...
                !$OMP PARALLEL DO DEFAULT(PRIVATE) SHARED(T, TT, STATE_EPOCH, STATE_TARG_ARR, NUM_ITERS, MU, &
                !$OMP& MULTI_REV, MIN_VEL, F_INDEX, OPT_STATE, OPT_STATE_UNROT, STATE_CAN, STATE_ROT_ARR) &

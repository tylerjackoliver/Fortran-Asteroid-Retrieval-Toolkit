module sorting_routines
    ...
    !
    ! Subroutine that sorts an array Array, and returns the permutation index of the array n such that the array is sorted from low (including -ve) to high.
    !
    ! Borrows heavily from Numerical Recipes in Fortran
    !

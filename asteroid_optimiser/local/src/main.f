...
C      call FURNSH('naif0008.tls')
C      call STR2ET('22 Sep 2028 00:00', TRANSFER_EPOCH)
C      call UNLOAD('naif0008.tls')
...
C     SET INITIAL GUESS
      ...
      XL(1)=0.64208021D9-21.d0 * 86400.D0
      XL(2)=0.12601424D9-21.d0*86400.D0

      XU(1)=0.64208021D9+21.D0 * 86400.D0
      XU(2)=0.12601424D9+21.D0* 86400.D0

C     INITIALISE BOUNDS
C     XL = [TRANSFER_EPOCH, TRANSFER_TIME]_LOWER
c     XU = [TRANSFER_EPOCH, TRANSFER_TIME]_UPPER

C      XL(1)=TRANSFER_EPOCH*.99D0
C      XL(2)=1241.d0*86400.d0*0.9D0
C      XU(1)=TRANSFER_EPOCH*1.01
C      XU(2)=1241.d0*86400.d0*1.1

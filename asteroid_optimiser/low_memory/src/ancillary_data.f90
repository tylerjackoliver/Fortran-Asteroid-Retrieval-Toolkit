module ancillary_data
    ...
    contains
        ...
        subroutine generate_ancillary_data(t_epoch, transfer_time, t_end, n_mnfd, orbit_num, &
            ...
            call GLOBAL_ROTATE(state_targ, t_epoch + transfer_time, state_dim)
            ...
            do j = 1, num_rows
                ...
                if (transfer_vel < min_vel) then
                    ...
                    min_vel = transfer_vel
                    r2 = state_rot                              ! r2 is the state at the end of the Lambert arc
                    v1O = (/(vx1-vcx), (vy1-vcy), (vz1-vcz)/) ! v1 is the velocity to get on the Lambert arc
                    v2O = (/(vtx-vx2), (vty-vy2), (vtz-vz2)/) ! v2 is the velocity to get off the Lambert arc
    ...
    subroutine get_pareto_front() 
        ...
        double precision    :: current_working_state(5)
        ...
        do pareto_solution = 1, number_of_pareto_solutions
            ...
            call write_pareto_body(final_velocity, current_working_state, r1, v1, r2, v2, target_point)
    ...
    subroutine write_pareto_head()
        ...
        write(iunit, '(A)') "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
        write(iunit, '(A)') " "
        write(iunit, '(A)', advance='no') "deltaV", "t0", "tt", " tend", " nmnfd"
        write(iunit, '(A)', advance='no') " J r1", " v1x v1y v1z [km/s]",  "r2"
        write(iunit, '(A)') " v2x v2y v2z [km/s]", " tmani [rS]", " xtarg [CR3BP]"
        write(iunit, '(A)') " "

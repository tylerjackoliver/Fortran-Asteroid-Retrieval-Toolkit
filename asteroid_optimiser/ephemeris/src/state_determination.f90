...
module state_determination
    ...
    implicit none
        ...
        contains
            ...
            subroutine CANDIDATE_POSITION_MOD(targ_can, t, tt, state_out)
                ...
                call FURNSH(targ_can//'.bsp')
                call FURNSH('naif0008.tls')
                call FURNSH('de414.bsp')

                call SPKEZR(targ_can, t+tt, coord, abcorr, obs, &
                state_out, dum)

                call UNLOAD(targ_can//'.bsp')
                call UNLOAD('naif0008.tls')
                call UNLOAD('de414.bsp')
        
            end subroutine CANDIDATE_POSITION_MOD
            ...
            subroutine ROTATOR_MOD(targ_can, epoch, tt, state_out)

                ! ////////////////////////////////////////////////////////////////////////////
                !
                ! Modified version of ROTATOR to always return the ephemeris state of the asteroid
                ! at any time
                !
                ! ///////////////////////////////////////////////////////////////////////////
                ...
                REAL(kind=dp),    intent(in)    :: epoch                                                                                    ! Epoch of the state
                REAL(kind=dp),    intent(in)    :: tt   
                CHARACTER(len=*), intent(in)    :: targ_can                                                                                    ! Transfer time
                ...
                call SPKEZR(targ_can, epoch+tt, coord, abcorr, obs, &
                state_out, dum)

    ...
    implicit none
        ...
        contains
            ...
            subroutine get_state(targ_can,state_out, time_count,time_lower,time_upper)
                ...
                CHARACTER(len=9)            :: targ_ear                                 ! String for holding the Earth
                ...
                do epoch_counter = epoch, epoch_upper, 86400
                    ...
                    ! Rotate into synodic frame

                    call synodic_rotate(state_can, epoch_counter, state_can)
            ...
            subroutine synodic_rotate(state_in, t, state_out)
                ...
                REAL(kind=dp), parameter    :: theta_0 = 100.3762 * 3.141592 / 180.d0

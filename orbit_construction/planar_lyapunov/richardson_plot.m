function [xx,th] = richardson_plot(mu,Lpt,Azlp,n);
% [xx,th] = richardson_plot(mu,Lpt,Azlp,n);
%
...
% Example:
%
% [xx,th]=richardson_plot(3.e-6,1,0.1,1); 
%
% gives the trajectory (xx) of a halo orbit in a system with mu=3.e-6,
% about Lagrange point 1, with nondimensional out-of-plane amplitude 0.1, 
% and the final 1 means that it's a "northern halo"
%
%--------------------------------------------------------------------------

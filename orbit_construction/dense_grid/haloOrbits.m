...
x0 = [1.001558975970106;0;0;0.061646603412747];

x0Step = 5e-06; % Should give us exactly 1000 orbits!
...
while cnt < 1000                                                            % Existing functonality; continue orbit 1000 times
    ...
    if (jacobiConst <= 2.999900 && jacobiConst >= 2.999800)
        
        % Immediately make the grid denser
